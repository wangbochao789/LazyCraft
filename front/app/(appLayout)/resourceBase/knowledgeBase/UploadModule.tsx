...
const UploadModal = (props: any) => {
  ...
  const { visible, id, onClose, onSuccess: successEvent, gettaglist } = props
        ...
        >
          <Dragger {...uploadProps}>
            ...
            <p className="ant-upload-hint">
              支持使用 pdf、word、ppt、excel、csv、 txt、json、html、markdown、 xml、latex，编码格式为utf-8,导入的数据要求单个大小50MB以内。
            </p>
          </Dragger>
